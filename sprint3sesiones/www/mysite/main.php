...
<html>
	<header>
		<style>
			...
			img {
				...
				text-align = center;
				transition: box-shadow 0.5s ease-in-out; /*Indicamos como se debe efectuar la transición de la sombra*/
			}

			img:hover { /* La transición se ejecuta al pasar el ratón */
			...
			/* Transición para los títulos de las canciones a blanco */
			h2 > a:hover {
				color: white;
	...
	<div> <!--Contenedor-->
		...
		<a href="/logout.php">Logout</a> <!--Para cerrar sesión-->
	<table>
		<?php
			...
			*/
			while ($row = mysqli_fetch_array($result)) {
				echo '<tr><th><h2><a href="/detail.php?cancion_id='.$row['id'].'" >'.$row[1].'</h2>';
